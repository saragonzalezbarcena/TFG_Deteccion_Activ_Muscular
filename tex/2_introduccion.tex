...
Sin embargo, muchos de ellos no llegan al mercado debido a la falta de portabilidad que dificulta su incorporación en la vida diaria del paciente y al requerimiento de un certificado de validación. Su fiabilidad depende del número de sensores empleados, su colocación en el cuerpo y del algoritmo de procesamiento empleado. 
...
\begin{enumerate}
    ...
    \item \textbf{Personalized Kinetigraph, PKG:} se trata de un biosensor de muñeca (reloj PKG)% como se muestra en la Figura \ref{fig:PKG}, 
    ...
    \item \textbf{PD Monitor:} se trata de un sistema de monitorización domiciliaria no invasivo . % (Figura \ref{fig:PDMonitor}) 
   ...
   % \end{figure}
    ...
    % como se puede observar en la Figura \ref{fig:staton}, es un
